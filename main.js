...
// const removeDivsFromLeftContainer = () => {
//   let divs = document.getElementsByClassName("news-container-one-column");
...
document.getElementById("plus-button").addEventListener("click", () => {
  ...
  div.classList.add(`index-${counter}`);
  document
...
document.getElementById("minus-button").addEventListener("click", () => {
  let div = document.getElementsByClassName(`index-${counter - 1}`)[0];
  div.remove();
  counter--;
});
